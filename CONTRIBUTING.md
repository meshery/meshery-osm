...
`git clone https://github.com/layer5io/meshery-osm`
...
1. Open a [pull request](../../pulls) (in your web browser) against the master branch on https://github.com/layer5io/meshery-osm.
